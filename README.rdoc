...
Here's to making a dent in things together!
----

= Dev notes

Platform workstream:
http://bettermeans.com/projects/2/dashboard

We are working on using bundler to wrap up the dev environment. 
...
All other the data in the dev database is real!
