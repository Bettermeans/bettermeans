ActionController::Routing::Routes.draw do |map|
  ...
  map.with_options :controller => 'issues' do |issues_routes|
    ...
    issues_routes.with_options :conditions => {:method => :post} do |issues_actions|
      ...
      issues_actions.connect 'issues/:id/:action', :action => /edit|move|destroy|start|finish|release|cancel|restart/, :id => /\d+/
    end
  ...
  map.with_options :controller => 'projects' do |projects|
    projects.with_options :conditions => {:method => :get} do |project_views|
      ...
      project_views.connect 'projects/:id/:action', :action => /roadmap|changelog|destroy|settings|team|wiki|join_core_team|leave_core_team|core_vote|dashdata|dashboard/
