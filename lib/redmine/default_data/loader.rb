    ...
    module Loader
      ...
      class << self
        ...
        def load(lang=nil)
          ...
          Role.transaction do
            # Roles
            administrator = Role.create! :name => l(:default_role_administrator), :position => 1, :builtin => Role::BUILTIN_ADMINISTRATOR, :scope => Role::SCOPE_PROJECT
            ...
            citizen = Role.create! :name => l(:default_role_citizen), :position => 2, :builtin => Role::BUILTIN_CORE_MEMBER, :scope => Role::SCOPE_PROJECT
            ...
            contributor = Role.create! :name => l(:default_role_contributor), :position => 3, :builtin => Role::BUILTIN_CONTRIBUTOR, :scope => Role::SCOPE_PROJECT
