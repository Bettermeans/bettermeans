...
class Setting < ActiveRecord::Base
  ...
  RETRO_CREDIT_THRESHOLD = 5000 # credit threshold for  retrospective to start. 
  ...
  DAYS_FOR_ACTIVE_MEMBERSHIP = 7 #If a member does any activity on a project in the last X days, they're considered active
